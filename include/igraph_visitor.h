...
IGRAPH_EXPORT igraph_error_t igraph_bfs_bottom_up(const igraph_t *graph,
                              igraph_integer_t root, const igraph_vector_int_t *roots,
                              igraph_neimode_t mode, igraph_bool_t unreachable,
                              const igraph_vector_int_t *restricted,
                              igraph_vector_int_t *parents, igraph_vector_int_t *dist);
IGRAPH_EXPORT igraph_error_t igraph_bfs_td_common_memory(const igraph_t *graph,
                              igraph_integer_t root, const igraph_vector_int_t *roots,
                              igraph_neimode_t mode, igraph_bool_t unreachable,
                              const igraph_vector_int_t *restricted,
                              igraph_vector_int_t *parents, igraph_vector_int_t *dist);
IGRAPH_EXPORT igraph_error_t igraph_bfs_bu_common_memory(const igraph_t *graph,
                              igraph_integer_t root, const igraph_vector_int_t *roots,
                              igraph_neimode_t mode, igraph_bool_t unreachable,
                              const igraph_vector_int_t *restricted,
                              igraph_vector_int_t *parents, igraph_vector_int_t *dist);
IGRAPH_EXPORT igraph_error_t igraph_bfs_combine(const igraph_t *graph,
               igraph_integer_t root, const igraph_vector_int_t *roots,
               igraph_neimode_t mode, igraph_bool_t unreachable,
               const igraph_vector_int_t *restricted,
               igraph_vector_int_t *parents, igraph_vector_int_t *dist);
IGRAPH_EXPORT igraph_error_t igraph_bfs_combine_common(const igraph_t *graph,
               igraph_integer_t root, const igraph_vector_int_t *roots,
               igraph_neimode_t mode, igraph_bool_t unreachable,
               const igraph_vector_int_t *restricted,
               igraph_vector_int_t *parents, igraph_vector_int_t *dist);
